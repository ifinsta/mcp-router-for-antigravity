...
- update the docs intentionally in the same change
...
1. Read the relevant section in `README.md` and `docs/`.
...
- contract change → update `README.md` and relevant documentation
- architecture change → update `docs/` documentation
- requirement change → update `docs/` documentation
- delivery or sequencing change → update `docs/` documentation
